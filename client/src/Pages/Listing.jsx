        ...
        <form onSubmit={handleSubmit} className='flex flex-col sm:flex-row gap-4'>
            ...
            <div className='flex gap-6 flex-wrap'>
              <div className='flex gap-2'>
                <input onChange={handleChange} type = "checkbox" id = "sale" className = "w-5" check={formData.type === 'sale'}/>
                <span>Sell</span>
              </div>
            
              <div className='flex gap-2'>
                <input onChange={handleChange} type = "checkbox" id = "rent" className = "w-5" check={formData.type === 'rent'}/>
                <span>Rent</span>
              </div>
            
            
              <div className='flex gap-2'>
                <input onChange={handleChange} type = "checkbox" id = "parking" className = "w-5" check={formData.parking}/>
                <span>Parking Spot</span>
              </div>
            
            
              <div className='flex gap-2'>
                <input type = "checkbox" id = "furnished" className = "w-5" onChange={handleChange} check={formData.furnished}/>
                <span>Furnished</span>
              </div>
            
            
              <div className='flex gap-2'>
                <input type = "checkbox" id = "offer" className = "w-5" onChange={handleChange} check={formData.offer}/>
                <span>Offer</span>
              </div>
            </div>
